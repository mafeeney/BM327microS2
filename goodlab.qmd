# IMPORTANT NOTES FOR WORKING IN A MICROBIOLOGY LAB
...
One popular and widely used electronic lab notebook is Benchling. 
...
Some general guidelines for good labelling practice:
...
*	If labelling Petri plates, label around the outside rim of the plate (do not obscure the plate as it will make it hard to count colonies!) and be sure to label the bottom of the plate (the bottom and lid may become separated, so labelling the lid is a bad idea.)
...
* Never set a pipet down, or hold it horizontally/at an angle, with a pipet tip attached. It can damage a pipet if liquid comes up into the barrel.
